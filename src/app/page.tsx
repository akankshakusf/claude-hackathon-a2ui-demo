...
function A2UIRenderer({ messages }: { messages: Record<string, unknown>[] }) {
  ...
  return (
    <div
      ref={containerRef}
      style={{ width: "100%", minHeight: "300px", background: "#fffdf8", borderRadius: "12px", padding: "24px", color: "#2c1a0e" }}
    />
  );
}
    ...
    <>
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        :root {
          /* Warm fall palette — browns, ambers, cream, white. No purple. */
          --bg: #fdf6ed;
          --surface: #fffdf8;
          --surface2: #f5e9d6;
          --border: rgba(101, 55, 15, 0.13);
          --border-hi: rgba(180, 90, 20, 0.5);

          --accent: #92400e;        /* deep amber-brown — primary action color */
          --accent-soft: #b45309;   /* medium amber */
          --accent2: #78350f;       /* dark walnut brown */
          --glow: rgba(146, 64, 14, 0.1);

          --text: #2c1a0e;          /* deep espresso brown */
          --muted: #7c5230;         /* warm medium brown */
          --dim: #b8956a;           /* dusty tan */
        ...
        body::before {
          ...
          inset: 0;
          background-image:
            linear-gradient(rgba(120, 70, 20, 0.05) 1px, transparent 1px),
            linear-gradient(90deg, rgba(120, 70, 20, 0.05) 1px, transparent 1px);
        ...
        .orb1 {
          ...
          background: radial-gradient(circle, rgba(210, 120, 30, 0.12), transparent 70%);
          top: -280px; left: -280px;
        }
        .orb2 {
          width: 560px; height: 560px;
          background: radial-gradient(circle, rgba(146, 64, 14, 0.08), transparent 70%);
        ...
        h1 {
          font-size: clamp(38px, 6.5vw, 68px); font-weight: 800;
        ...
        .iw {
          ...
          box-shadow: 0 1px 4px rgba(100, 50, 10, 0.08);
        }
        .iw:focus-within {
          border-color: var(--border-hi);
          box-shadow: 0 0 0 3px var(--glow), 0 4px 20px rgba(100, 50, 10, 0.1);
        }
        .iw textarea {
        ...
        .go {
          ...
          color: #fffdf8; border:none; border-radius:9px;
          width:38px; height:38px; cursor:pointer;
          display:flex; align-items:center; justify-content:center;
          font-size:17px; transition: opacity 0.15s, transform 0.15s;
          flex-shrink:0; box-shadow: 0 2px 8px rgba(146, 64, 14, 0.35);
        }
        ...
        .chip {
          font-family: var(--mono); font-size: 11px; padding: 6px 13px;
        ...
        .dot:nth-child(2) { animation-delay:0.2s; background: #d97706; }
        .dot:nth-child(3) { animation-delay:0.4s; background: #b45309; }
        @keyframes bop {
        ...
        .ab:hover { border-color: rgba(146, 64, 14, 0.35); color: var(--accent); }
        .ab.p {
          background: rgba(146, 64, 14, 0.08);
          border-color: rgba(146, 64, 14, 0.3);
          color: var(--accent);
        }
        .ab.p:hover { background: rgba(146, 64, 14, 0.14); }
        ...
        .canvas {
          ...
          padding: 32px 24px 52px; background: var(--bg);
        }
        ...
        .ri {
          ...
          font-size:14px; padding:10px 16px; outline:none; transition: border-color 0.2s;
        }
        ...
        .timeline-strip {
          ...
          overflow-x: auto; scrollbar-width: none; flex: 1; padding-bottom: 2px;
        }
        ...
        .pill-now-label { font-family: var(--mono); font-size: 9px; color: #b45309; letter-spacing: 0.1em; }
        ...
        .modal-box {
          ...
          border-radius: 18px; width: 100%; max-width: 760px; max-height: 88vh;
          display: flex; flex-direction: column;
          box-shadow: 0 24px 80px rgba(44, 26, 14, 0.18), 0 0 0 1px rgba(146, 64, 14, 0.07);
        ...
        .modal-footer {
          ...
          background: var(--surface2); border-radius: 0 0 18px 18px;
        }
          ...
          <div className="rendered">
            <div className="rh">
              ...
              <div className="ras">
                ...
                <button className="ab p" onClick={() => { refineRef.current?.focus(); refineRef.current?.scrollIntoView({ behavior: 'smooth' }); }}>Refine ↑</button>
            ...
            <div className="refbar">
              <input
                ref={refineRef}
                className="ri"
                placeholder="Refine — e.g. 'add a phone field' or 'KPI should be FinTech'"
                onKeyDown={(e) => {
                  if (e.key === "Enter") {
